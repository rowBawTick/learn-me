<template>
  <div class="space-y-4">
    ...
    <div v-for="(slot, index) in modelValue" :key="index" class="p-4 bg-gray-50 rounded-lg">
      <div class="flex items-center justify-between mb-4">
        <h4 class="text-sm font-medium text-darkerGrey">Time Slot {{ index + 1 }}</h4>
        <q-btn
          flat
          round
          color="negative"
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          <label class="block text-sm font-medium text-darkerGrey mb-1">Day of Week</label>
          <q-select
        ...
        <div class="grid grid-cols-2 gap-2">
          <div>
            <label class="block text-sm font-medium text-darkerGrey mb-1">Start Time</label>
            <q-input
          ...
          <div>
            <label class="block text-sm font-medium text-darkerGrey mb-1">End Time</label>
            <q-input
