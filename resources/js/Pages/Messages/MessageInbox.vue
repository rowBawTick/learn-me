    ...
    <MainLayout>
        <div class="flex h-[90vh] mt-5 bg-gray-50 p-2 sm:p-4">
            <div class="flex flex-col md:flex-row flex-1 gap-4 min-h-0">
                ...
                <div class="order-2 md:order-1 flex-none md:w-1/3 h-[45vh] md:h-[90vh] bg-white rounded-lg overflow-hidden">
                    <ConversationList
                ...
                <div class="order-1 md:order-2 flex-1 h-[45vh] md:w-2/3 md:h-[90vh] bg-white rounded-lg overflow-hidden">
